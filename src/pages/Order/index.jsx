...
import { actionGetAllOrders } from "../../store/order/action";
        ...
        >
          <div className="col-span-1 overflow-auto bg-white shadow-lg p-4">
            ...
            >
              ...
              <tbody>
                {allOrders ? (
                  <CategoryTable key={123} orders={allOrders} />
                ) : (
                  <tr>
                    <td
                      colSpan="12"
            ...
            <div className="text-sm text-gray-600 mt-2">Total1 order found</div>
          </div>
        </div>
      </section>
    </React.Fragment>
            ...
            <tr className="border-b">
              <>
                ...
                >
                  ...
                  <div>Address: {order.address.address}</div>
                </td>
                          ...
                          onClick={async () => {
                            await Promise.all([
                              ...
                              setAddressShip((pre) => {
                                const newState = {
                                  ...pre,
                                  [item._id]: order.address.address,
                                };
                              ...
                              setPhoneNumberShip((pre) => {
                                const newState = {
                                  ...pre,
                                  [item._id]: order.address.phoneNumber,
                                };
                              ...
                              setZipCodeShip((pre) => {
                                const newState = {
                                  ...pre,
                                  [item._id]: order.address.zipCode,
                                };
